...
VALUES ('https://postimg.cc/tZWnCj5Q', 'Ciboulette_1'),
	('https://postimg.cc/m14zP5Xc', 'Ciboulette_2'),
	('https://postimg.cc/bSRGk9Wm', 'Ciboulette_3'),
	('https://postimg.cc/wRxLBBjy', 'Abrousier_1'),
	('https://postimg.cc/CBsbY8Sp', 'Abrousier_2'),
	('https://postimg.cc/gXW3fs9K', 'Abrousier_3'),
	('https://postimg.cc/nMVDBCnM', 'Estragon_1'),
	('https://postimg.cc/fSbSNg8Y', 'Estragon_2'),
	('https://postimg.cc/mzj1KGyb', 'Estragon_3'),
	('https://postimg.cc/t7mY6krm', 'Basilic_1'),
	('https://postimg.cc/hhGXh60d', 'Basilic_2'),
	('https://postimg.cc/vg0D3tGT', 'Basilic_3'),
	('https://postimg.cc/5YYDRxVz', 'Batavia_1'),
	('https://postimg.cc/3ybP1kP7', 'Batavia_2'),
	('https://postimg.cc/nsLyq4S0', 'Batavia_3'),
	('https://postimg.cc/zVS6Mt9x', 'Bouleau_blanc_1'),
	('https://postimg.cc/Mn6N80wq', 'Bouleau_blanc_2'),
	('https://postimg.cc/jLrBM0kW', 'Bouleau_blanc_3'),
	('https://postimg.cc/DSwjN2Qz', 'Cassis_1'),
	('https://postimg.cc/nCkSTsD5', 'Cassis_2'),
	('https://postimg.cc/4mZFzvmV', 'Cassis_3'),
	('https://postimg.cc/yWXz48Rh', 'Citronnier_1'),
	('https://postimg.cc/RNSxMx1k', 'Citronnier_2'),
	('https://postimg.cc/fkhhr9VT', 'Citronnier_3');
