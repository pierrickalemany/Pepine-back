...
VALUES
  ('ALLIUM schoenoprasum', 'Ciboulette', 'En été, les tiges creuses, dressées et odorantes de la ciboulette portent jusqu''à 20 fleurs violet clair ou roses disposées en ombelle dense et pouvant atteindre jusqu''à 5 cm d''envergure. Allium schoenoprasum est une plante vivace bulbeuse, comestible (tiges et fleurs), facile à vivre, utilisée comme condiment. Il est toutefois préférable de couper les fleurs avant qu''elles ne montent en graines...', '', '', '', '', '', '', '', '15 cm', '1 L', false, 15, 10, 2.60, 1, 2, 1, 3, 1, 2, 3, 2),
  ('Arbutus unedo', 'Arbousier', 'L’Arbousier Atlantic (Arbutus unedo) est une variété au port compact de croissance relativement lente, il est très ornementale grâce à son beau feuillage persistant et son écorce de couleur brun rougeâtre...', 'Parfois appelé ‘arbre aux fraises’, cet arbuste produit de gros fruits rouges en automne...', 'Hauteur de 1 à 10 m selon la conduite', 'NC largeur adulte', 'NC famille', 'NC origine', 'NC couleu Fleurs', 'NC couleur feuille', '150 cm', '15 L', false, 3, 10, 18.20, 1, 2, 1, 3, 1, 2, 3, 2),
  ('ARTEMISIA dranunculus', 'Estragon', 'Cette vivace condimentaire, odorante, s''utilise fraiche ou sèche pour aromatiser sauces, plats, salades ou conserves au vinaigre. Les feuilles aiguës sont disposées le long de fines tiges dressées. Des panicules de petites fleurs vert jaune apparaissent dans le courant de l''été. Les graines sont stériles...', '', '1 mètre', '30 cm', 'Asteraceae', 'Horticole', '', 'Vert moyen', '15 cm', '1 L', false, 5, 10, 1.64, 1, 2, 1, 3, 1, 2, 3, 2),
  ('Basilic', 'Basilic', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pulvinar ligula in felis lacinia, id eleifend neque consectetur.', '', '250 cm', '100cm', 'jedi', 'bamaco', 'noir', 'bleu', '105 cm', '10 L', false, 0, 10, 0.00, 1, 2, 1, 3, 1, 2, 3, 2),
  ('Batavia', 'Batavia', '', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pulvinar ligula in felis lacinia, id eleifend neque consectetur.', '', '50 cm', '500 cm', 'padawan', 'naboo', 'orange', '20 cm', '3 L', false, 100, 100, 0.00, 1, 2, 1, 3, 1, 2, 3, 2),
  ('Betula alba verrucosa', 'Bouleau Blanc', '', '', '', '', '', '', '', '', '15 cm', '1 L', false, 1, 10, 40.30, 1, 2, 1, 3, 1, 2, 3, 2),
  ('Ribes nigrum', 'Cassis', 'Le Cassissier aussi appelé "Groseillier Noir" est originaire du Nord de l''Europe et de l''Asie...', 'Le Cassissier est un arbuste ou arbrisseau touffu et odorant...', '120 cm.', '120 cm.', 'Grossulariaceae', 'Nord, Est et Centre de l''Europe.', 'Rouge foncé', 'Vert foncé', '15 cm', '1 L', false, 2, 10, 0.00, 1, 2, 1, 3, 1, 2, 3, 2),
  ('CITRUS limon Lunario sur P.trifoliata', 'Citronnier 4 saisons', 'Citronnier 4 saisons, Lunari ou Lunario est un magnifique agrume qui doit son nom au fait qu’il porte fleurs et fruits durant les quatre saisons...', '', '', '', '', '', '', '', '105 cm', '10 L', false, 9, 10, 22.85, 1, 2, 1, 3, 1, 2, 3, 2);
