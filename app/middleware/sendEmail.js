...
async function sendPasswordResetEmail(email, resetToken) {
  const mailOptions = {
    ...
    html: `
      ...
      <a href="${process.env.URL_RESET_PASSWORD}?token=${resetToken}" style="background-color: #F79323; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">Réinitialiser le mot de passe</a>
